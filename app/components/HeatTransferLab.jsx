...
<Container maxWidth="lg" sx={{ py: 4 }}>
    ...
    <Grid container spacing={3}>
        ...
        <Card>
            <CardHeader title="Perfil de Temperatura" subheader="Condução estacionária em placa plana" />
            <CardContent>
    ...
    <Grid container spacing={3}>
        ...
        <Card>
            ...
            <CardContent>
            <Stack spacing={2}>
                <TextField label="Coeficiente convectivo h" type="number" value={h}
                onChange={(e) => setH(Number(e.target.value) || 0)}
                InputProps={{ endAdornment: <InputAdornment position="end">W/m²·K</InputAdornment> }} />

                <TextField label="Área A" type="number" value={Aconv}
                onChange={(e) => setAconv(Number(e.target.value) || 0)}
                InputProps={{ endAdornment: <InputAdornment position="end">m²</InputAdornment> }} />

                <Grid container spacing={1}>
                <Grid item xs={6}>
                    <TextField fullWidth label="Temperatura da superfície Tₛ" type="number" value={Ts}
                    onChange={(e) => setTs(Number(e.target.value) || 0)}
                    InputProps={{ endAdornment: <InputAdornment position="end">°C</InputAdornment> }} />
                </Grid>
                <Grid item xs={6}>
                    <TextField fullWidth label="Temperatura do fluido T∞" type="number" value={Tinf}
        ...
        <Card>
            <CardHeader title="Fluxo ao longo da superfície" subheader="Modelo simples com h uniforme" />
            <CardContent>
            <Box sx={{ width: '100%', height: 420 }}>
    ...
    <Grid container spacing={3}>
        ...
        <Card>
            ...
            <CardContent>
            <Stack spacing={2}>
                <TextField label="Emissividade ε" type="number" value={eps}
                onChange={(e) => setEps(Number(e.target.value) || 0)}
                inputProps={{ step: 0.01, min: 0, max: 1 }}
                InputProps={{ endAdornment: <InputAdornment position="end">—</InputAdornment> }} />

                <TextField label="Área A" type="number" value={Arad}
                onChange={(e) => setArad(Number(e.target.value) || 0)}
                InputProps={{ endAdornment: <InputAdornment position="end">m²</InputAdornment> }} />

                <Grid container spacing={1}>
                <Grid item xs={6}>
                    <TextField fullWidth label="Temperatura da superfície Tₛ" type="number" value={TsR}
                    onChange={(e) => setTsR(Number(e.target.value) || 0)}
                    InputProps={{ endAdornment: <InputAdornment position="end">°C</InputAdornment> }} />
                </Grid>
                <Grid item xs={6}>
                    <TextField fullWidth label="Temperatura do entorno Tₛᵤʳ" type="number" value={Tsur}
        ...
        <Card>
            <CardHeader title="Fluxo ao longo da superfície" subheader="Superfície grande para um entorno a Tₛᵤʳ" />
            <CardContent>
            <Box sx={{ width: '100%', height: 420 }}>
