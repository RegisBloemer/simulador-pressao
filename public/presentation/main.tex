...
\begin{frame}{Jogo: Controle de Tanques Pressurizados}
  ...
  % Lembrar de explicar as fórmulas usadas no modelo, elemento por elemento e como eles afetam.
...
\textbf{Volume de água:}
  $$  V(t+\Delta t) = V(t) + (Q_{in} - Q_{out}) \cdot \Delta t, \quad \dfrac{dV}{dt} = Q_{\text{in}} - Q_{\text{out}}$$
\end{frame}
